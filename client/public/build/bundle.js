...
var app = (function () {
    ...
    function instance$3($$self) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("tokenValue" in $$props) tokenValue = $$props.tokenValue;
    	};
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$2, 29, 4, 711);
    			add_location(br, file$2, 30, 4, 767);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "name", "password");
    			attr_dev(input1, "id", "password");
    			add_location(input1, file$2, 31, 4, 778);
    			attr_dev(input2, "type", "submit");
    			input2.value = "login";
    			add_location(input2, file$2, 33, 6, 848);
    			add_location(p, file$2, 32, 4, 838);
    			attr_dev(form, "class", "loginForm");
    			attr_dev(form, "action", "/login");
    			attr_dev(form, "method", "post");
    			add_location(form, file$2, 24, 2, 596);
    			add_location(main, file$2, 23, 0, 587);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
